<div x-data="{ type: 'all' }" class="flex flex-col h-full overflow-hidden transition-all">
    ...
    <main class="relative h-full overflow-hidden overflow-y-scroll grow" style="contain:content">
        ...
        <ul class="grid w-full p-2 spacey-y-2">
            <li
                class="relative flex w-full gap-4 px-2 py-3 transition-colors duration-150 cursor-pointer hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70">
                    ...
                    <div class="flex flex-col col-span-1 my-auto text-center">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="trigger">
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="w-5 h-5 text-gray-700 bi bi-three-dots-vertical"
                                        viewBox="0 0 16 16">
                                        <path
